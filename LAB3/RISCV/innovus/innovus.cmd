...
#  Created on Sat Feb 12 23:44:40 2022                
#                                                     
#######################################################
...
timeDesign -preCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix riscv_preCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix riscv_postCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
